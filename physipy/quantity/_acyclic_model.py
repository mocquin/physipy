...
class DependentAttr(object):
    ...
    def __init__(self, init_value, dependencies_list_of_attr_str: list,
                 calc_func_str: str, name):
        """
    ...
    def __get__(self, obj, objtype):
        ...
        if self.value is AttrNullState:
            ...
            for dependency in self.dependencies_list_of_attr_str:
                ...
                # Throw an error if the update was not successful and it should
                # have been.
    ...
    def __set__(self, obj, value):
        if self.value is not value:
            ...
            for child in self.children:
                # In turn, these attributes will set their children to null
                # state, and so forth.
...
if __name__ == '__main__':
    ...
    # Define a class with interdependent attributes and the functions that
    # update them.
    class DataflowFail():
        ...
        # Define the functions responsible for updating the dependent
        # attributes
    ...
    class DataflowSuccess(DataflowFail):
        ...
        # The following defines the directed acyclic computation graph for
        # these attributes.
        ...
        # Inherets the rest of DataflowFail, including its updating functions
        # for the dependent attributes.

    # Execute the test.
    print('------------- Testing the bad way of updating dependent attributes ------------')
    # Demonstrate no handling of data flow.
    program_bad = DataflowFail()
    # A full update works, but is computationally expensive and not always
    # necessary.
    ...
    # No explicit updating required. Getting the value (.a7) triggers all
    # necessary updates.
