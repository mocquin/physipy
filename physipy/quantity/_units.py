...
def _CREATE_BASE_SI_UNIT_DICT(
    prefix_dic: dict, base_units_symbol_dim: dict, dic: dict = {}
) -> dict:
    """
...
SI_units = {
    value: Quantity(1, Dimension(key), symbol=value)
...
SI_units_prefixed = _CREATE_BASE_SI_UNIT_DICT(
    _PREFIX_DICT, SI_UNIT_SYMBOL, SI_units
)  # extends SI_units
...
SI_derived_units_prefixed = prefix_units(_PREFIX_DICT, SI_derived_units)
...
raw_imperial_units = {
    ...
    * s ** (-2),
    ...
    "kcal": 1000 * 4.184 * J,
    # PRESSURE
    "psi": (32.174049 * 16 * 28.349523125 * g)
    * (12 * 2.54 * cm)
    * s ** (-2)
    * (2.54 * cm) ** (-2),
    # POWER
