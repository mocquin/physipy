...
class TestNumpyFunctions(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.arr_3d = np.array([[[1, 2, np.nan], [3, 4, 5]], [[6, 7, 8], [9, 10, np.nan]]])
        self.arr_3d_extra = m * np.array([[[1, 2, np.nan, 4], [5, 6, 7, 8], [9, 10, 11, np.nan]],
    ...
    def test_nancumsum(self):
        ...
        self.assertTrue(np.allclose(np.nancumsum(self.arr), expected_cumsum, atol=1e-08*m))
